...
export const MAX_ROUNDTRIP = DEBUG.localTestRTT ? 100 : process.env.TORBB ? 4000 : (DEBUG.overrideMaxRTT || 800);
export const MIN_ROUNDTRIP = DEBUG.localTestRTT ? 80 : process.env.TORBB ? 2000 : 625;
export const MIN_SPOT_ROUNDTRIP = process.env.TORBB ? 615 : 135;
export const BUF_SEND_TIMEOUT = 80;
