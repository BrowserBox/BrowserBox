...
export const DOMAIN_NAME = 'license.dosaygo.com';
...
export const DISTRIBUTION_SERVER_URL = `https://license.dosaygo.com`;
export const LICENSE_SERVER_URL = `https://master.dosaygo.com`;
