...
$serviceDirs = @("src/zombie-lord", "../public/voodoo", "../../endbacker", "../../zombie-lord/custom-launcher", "../../", "services/instance/parec-server", "../", "pptr-console-server", "websocket_chat_app_homework", "../", "../", "../pool/crdp-secure-proxy-server", "../chai", "../../../../")
