...
rollup ./src/public/image-start-app.js -c ./config/rollup.config.js --format iife --file ./src/public/bundle_image_start.js --name App
...
rollup ./src/public/meta.js -c ./config/rollup.config.js --format iife --file ./src/public/meta_bundle.js --name Meta
