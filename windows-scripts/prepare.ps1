...
# Base install dir on parent of this script's directory (works for repo and installed layout)
$installDir = Resolve-Path (Join-Path $scriptRoot "..")
$originalDir = Get-Location

# Skip optional deps (native modules) on Windows
$env:NPM_CONFIG_OPTIONAL = "false"
$env:NPM_CONFIG_INCLUDE_OPTIONAL = "false"
